...
namespace SurvLine
{
    internal class Pmemo
    {
        ...
        //***************************************************************************
        //プログラム＜プロジェクト＞
        //Git管理：コメント＞(ブランチ:B240331-0)24/04/05:Net60対応マージ前

        //Git管理：コメント＞(ブランチ:B240331-0)24/03/XX-6(完)編集：反転・重複・前半・後半
        //
        //＜コメント＞
        ...
        */
            ...
            //*************************************************************************
            // IIf(Asc(LTrim(txtElevationBCH.Text)) = 45, -1, 1
...
//*************************************************************************
        ...
        //***************************************************************************
        //プログラム＜プロジェクト＞
        //Git管理：コメント＞(ブランチ:B240323A)24/03/26(完)編集:採用／点検
        //
        //＜コメント＞
        ...
        //***************************************************************************
        //プログラム＜プロジェクト＞
        //Git管理：コメント＞(ブランチ:B240322-0)24/03/23(完)編集:有効／無効
        //
        //＜コメント＞
