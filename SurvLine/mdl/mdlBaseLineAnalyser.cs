...
namespace SurvLine.mdl
{
    public class MdlBaseLineAnalyser
    {
        ...
        public static string[] DISP_ANALYSIS = new string[(long)ANALYSIS_STATUS.ANALYSIS_STATUS_COUNT];
        ...
        public static string[] DISP_ORBIT = new string[(long)ORBIT_TYPE.ORBIT_COUNT];
        ...
        public static string[] DISP_LC = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT];
        ...
        public static string[] DISP_LC_R = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT - (long)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD];
        ...
        public static string[] DISP_LC_E = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT - (long)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD];
        ...
        public static string[] DISP_LC_C = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT - (long)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD];
        //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        public static string[] DISP_FREQUENCY = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT];
        ...
        public static string[] DISP_FREQUENCY_R = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT - (long)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD];
        ...
        public static string[] DISP_FREQUENCY_E = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT - (long)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD];
        ...
        public static string[] DISP_FREQUENCY_C = new string[(long)FREQUENCY_TYPE.FREQUENCY_COUNT - (long)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD];
        //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
        ...
        public static string[] DISP_SOLVEMODE = new string[(long)SOLVEMODE_TYPE.SOLVEMODE_COUNT];
        ...
        public static string[] DISP_TROPOSHERE = new string[8];
        ...
        public static string[] DISP_TROPMAP = new string[(long)TROPMAP_TYPE.TROPMAP_COUNT];
        ...
        public static string[] EXCLUDE_SV = new string[PPS_MAXPRN_SET];
        ...
        //'楕円体モデル。
        public static string[] DISP_ELLIPSE_MODEL = new string[(long)ELLIPSE_MODEL.ELLIPSE_MODEL_COUNT];

        public MdlBaseLineAnalyser BASE_LINE_ANALYSER;                                      //'基線解析器。
        ...
        {
            //'解の種類。
            DISP_ANALYSIS[(int)ANALYSIS_STATUS.ANALYSIS_STATUS_FLOAT] = DISP_ANALYSIS_FLOAT;
            DISP_ANALYSIS[(int)ANALYSIS_STATUS.ANALYSIS_STATUS_FIX] = DISP_ANALYSIS_FIX;
            DISP_ANALYSIS[(int)ANALYSIS_STATUS.ANALYSIS_STATUS_FAILED] = DISP_ANALYSIS_FAILED;
            DISP_ANALYSIS[(int)ANALYSIS_STATUS.ANALYSIS_STATUS_NOT] = DISP_ANALYSIS_NOT;
            //'軌道暦。
            DISP_ORBIT[(int)ORBIT_TYPE.ORBIT_BROADCAST] = DISP_ORBIT_BROADCAST;
            DISP_ORBIT[(int)ORBIT_TYPE.ORBIT_PRECISE] = DISP_ORBIT_PRECISE;
            //'周波数。
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L1] = DISP_LC_L1;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L2] = DISP_LC_L2;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L1L2] = DISP_LC_L1L2;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L5] = DISP_LC_L5;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L3] = DISP_LC_L3;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L5L3] = DISP_LC_L5L3;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_AUTO] = DISP_LC_AUTO;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_LC_NONE] = DISP_LC_NONE;
            //'2017/07/13 NS6000対応。'''''''''''''''''''''''''''''''''''''''''''''''''''''''
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_1F] = DISP_LC_1F;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_2F] = DISP_LC_2F;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_L1L5] = DISP_LC_L1L5;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_3F] = DISP_LC_3F;
            DISP_LC[(int)FREQUENCY_TYPE.FREQUENCY_IFMW] = DISP_LC_IFMW;


            DISP_LC_R[(int)FREQUENCY_TYPE.FREQUENCY_1F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_R_1F;
            DISP_LC_R[(int)FREQUENCY_TYPE.FREQUENCY_2F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_R_2F;
            DISP_LC_R[(int)FREQUENCY_TYPE.FREQUENCY_L1L5 - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_R_L1L5;
            DISP_LC_R[(int)FREQUENCY_TYPE.FREQUENCY_3F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_R_3F;
            DISP_LC_R[(int)FREQUENCY_TYPE.FREQUENCY_IFMW - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_R_IFMW;
            DISP_LC_E[(int)FREQUENCY_TYPE.FREQUENCY_1F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_E_1F;
            DISP_LC_E[(int)FREQUENCY_TYPE.FREQUENCY_2F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_E_2F;
            DISP_LC_E[(int)FREQUENCY_TYPE.FREQUENCY_L1L5 - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_E_L1L5;
            DISP_LC_E[(int)FREQUENCY_TYPE.FREQUENCY_3F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_E_3F;
            DISP_LC_E[(int)FREQUENCY_TYPE.FREQUENCY_IFMW - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_E_IFMW;
            DISP_LC_C[(int)FREQUENCY_TYPE.FREQUENCY_1F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_C_1F;
            DISP_LC_C[(int)FREQUENCY_TYPE.FREQUENCY_2F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_C_2F;
            DISP_LC_C[(int)FREQUENCY_TYPE.FREQUENCY_L1L5 - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_C_L1L5;
            DISP_LC_C[(int)FREQUENCY_TYPE.FREQUENCY_3F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_C_3F;
            DISP_LC_C[(int)FREQUENCY_TYPE.FREQUENCY_IFMW - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_LC_C_IFMW;
            //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''


            //'使用した周波数。
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L1] = DISP_FREQUENCY_L1;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L2] = DISP_FREQUENCY_L2;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L1L2] = DISP_FREQUENCY_L1L2;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L5] = DISP_FREQUENCY_L5;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L3] = DISP_FREQUENCY_L3;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L5L3] = DISP_FREQUENCY_L5L3;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_AUTO] = DISP_FREQUENCY_AUTO;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_LC_NONE] = DISP_FREQUENCY_LC_NONE;
            //'2017/07/13 NS6000対応。'''''''''''''''''''''''''''''''''''''''''''''''''''''''
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_1F] = DISP_FREQUENCY_1F;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_2F] = DISP_FREQUENCY_2F;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_L1L5] = DISP_FREQUENCY_L1L5;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_3F] = DISP_FREQUENCY_3F;
            DISP_FREQUENCY[(int)FREQUENCY_TYPE.FREQUENCY_IFMW] = DISP_FREQUENCY_IFMW;


            DISP_FREQUENCY_R[(int)FREQUENCY_TYPE.FREQUENCY_1F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_R_1F;
            DISP_FREQUENCY_R[(int)FREQUENCY_TYPE.FREQUENCY_2F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_R_2F;
            DISP_FREQUENCY_R[(int)FREQUENCY_TYPE.FREQUENCY_L1L5 - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_R_L1L5;
            DISP_FREQUENCY_R[(int)FREQUENCY_TYPE.FREQUENCY_3F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_R_3F;
            DISP_FREQUENCY_R[(int)FREQUENCY_TYPE.FREQUENCY_IFMW - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_R_IFMW;
            DISP_FREQUENCY_E[(int)FREQUENCY_TYPE.FREQUENCY_1F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_E_1F;
            DISP_FREQUENCY_E[(int)FREQUENCY_TYPE.FREQUENCY_2F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_E_2F;
            DISP_FREQUENCY_E[(int)FREQUENCY_TYPE.FREQUENCY_L1L5 - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_E_L1L5;
            DISP_FREQUENCY_E[(int)FREQUENCY_TYPE.FREQUENCY_3F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_E_3F;
            DISP_FREQUENCY_E[(int)FREQUENCY_TYPE.FREQUENCY_IFMW - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_E_IFMW;
            DISP_FREQUENCY_C[(int)FREQUENCY_TYPE.FREQUENCY_1F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_C_1F;
            DISP_FREQUENCY_C[(int)FREQUENCY_TYPE.FREQUENCY_2F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_C_2F;
            DISP_FREQUENCY_C[(int)FREQUENCY_TYPE.FREQUENCY_L1L5 - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_C_L1L5;
            DISP_FREQUENCY_C[(int)FREQUENCY_TYPE.FREQUENCY_3F - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_C_3F;
            DISP_FREQUENCY_C[(int)FREQUENCY_TYPE.FREQUENCY_IFMW - (int)FREQUENCY_TYPE.FREQUENCY_COUNT_OLD] = DISP_FREQUENCY_C_IFMW;
            //'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
            //'基線解析モード。
            DISP_SOLVEMODE[(int)SOLVEMODE_TYPE.SOLVEMODE_STATIC] = DISP_SOLVEMODE_STATIC;
            DISP_SOLVEMODE[(int)SOLVEMODE_TYPE.SOLVEMODE_KINEMATICS] = DISP_SOLVEMODE_KINEMATICS;
            //'対流圏モデル。
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_SAASRTAMOINEN_OLD] = DISP_TROPOSHERE_SAASRTAMOINEN;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_MARINI_OLD] = DISP_TROPOSHERE_MARINI;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_HOPFIELD_OLD] = DISP_TROPOSHERE_HOPFIELD;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_NONE_OLD] = DISP_TROPOSHERE_NONE;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_SAASRTAMOINEN] = DISP_TROPOSHERE_SAASRTAMOINEN;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_MARINI] = DISP_TROPOSHERE_MARINI;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_HOPFIELD] = DISP_TROPOSHERE_HOPFIELD;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_UNB3M] = DISP_TROPOSHERE_UNB3M;
            DISP_TROPOSHERE[(int)TROPOSHERE_TYPE.TROPOSHERE_NONE] = DISP_TROPOSHERE_NONE;
            //'対流圏のマッピング。
            DISP_TROPMAP[(int)TROPMAP_TYPE.TROPMAP_COSZ] = DISP_TROPMAP_COSZ;
            DISP_TROPMAP[(int)TROPMAP_TYPE.TROPMAP_DRY_NIELL] = DISP_TROPMAP_DRY_NIELL;
            DISP_TROPMAP[(int)TROPMAP_TYPE.TROPMAP_WET_NIELL] = DISP_TROPMAP_WET_NIELL;
            DISP_TROPMAP[(int)TROPMAP_TYPE.TROPMAP_HOPF] = DISP_TROPMAP_HOPF;
            DISP_TROPMAP[(int)TROPMAP_TYPE.TROPMAP_NONE] = DISP_TROPMAP_NONE;
            //'楕円体モデル。
            DISP_ELLIPSE_MODEL[(int)ELLIPSE_MODEL.ELLIPSE_MODEL_GRS80] = DISP_ELLIPSE_MODEL_GRS80;
            DISP_ELLIPSE_MODEL[(int)ELLIPSE_MODEL.ELLIPSE_MODEL_WGS84] = DISP_ELLIPSE_MODEL_WGS84;
            //'使用衛星ビットフラグ。
            long i1;
            i1 = 0x01;
            EXCLUDE_SV[0] = i1.ToString("X");   //'GPS01。
            i1 = 0x02;
            EXCLUDE_SV[1] = i1.ToString("X");   //'GPS02。
            i1 = 0x04;
            EXCLUDE_SV[2] = i1.ToString("X");   //'GPS03。
            i1 = 0x08;
            EXCLUDE_SV[3] = i1.ToString("X");   //'GPS04。
            i1 = 0x10;
            EXCLUDE_SV[4] = i1.ToString("X");   //'GPS05。
            i1 = 0x20;
            EXCLUDE_SV[5] = i1.ToString("X");   //'GPS06。
            i1 = 0x40;
            EXCLUDE_SV[6] = i1.ToString("X");   //'GPS07。
            i1 = 0x80;
            EXCLUDE_SV[7] = i1.ToString("X");   //'GPS08。
            i1 = 0x100;
            EXCLUDE_SV[8] = i1.ToString("X");   //'GPS09。
            i1 = 0x200;
            EXCLUDE_SV[9] = i1.ToString("X");   //'GPS10。
            i1 = 0x400;
            EXCLUDE_SV[10] = i1.ToString("X");  //'GPS11。
            i1 = 0x800;
            EXCLUDE_SV[11] = i1.ToString("X");  //'GPS12。
            i1 = 0x1000;
            EXCLUDE_SV[12] = i1.ToString("X");  //'GPS13。
            i1 = 0x2000;
            EXCLUDE_SV[13] = i1.ToString("X");  //'GPS14。
            i1 = 0x4000;
            EXCLUDE_SV[14] = i1.ToString("X");  //'GPS15。
            i1 = 0x8000;
            EXCLUDE_SV[15] = i1.ToString("X");  //'GPS16。
            i1 = 0x10000;
            EXCLUDE_SV[16] = i1.ToString("X");  //'GPS17。
            i1 = 0x20000;
            EXCLUDE_SV[17] = i1.ToString("X");  //'GPS18。
            i1 = 0x40000;
            EXCLUDE_SV[18] = i1.ToString("X");  //'GPS19。
            i1 = 0x80000;
            EXCLUDE_SV[19] = i1.ToString("X");  //'GPS20。
            i1 = 0x100000;
            EXCLUDE_SV[20] = i1.ToString("X");  //'GPS21。
            i1 = 0x200000;
            EXCLUDE_SV[21] = i1.ToString("X");  //'GPS22。
            i1 = 0x400000;
            EXCLUDE_SV[22] = i1.ToString("X");  //'GPS23。
            i1 = 0x800000;
            EXCLUDE_SV[23] = i1.ToString("X");  //'GPS24。
            i1 = 0x1000000;
            EXCLUDE_SV[24] = i1.ToString("X");  //'GPS25。
            i1 = 0x2000000;
            EXCLUDE_SV[25] = i1.ToString("X");  //'GPS26。
            i1 = 0x4000000;
            EXCLUDE_SV[26] = i1.ToString("X");  //'GPS27。
            i1 = 0x8000000;
            EXCLUDE_SV[27] = i1.ToString("X");  //'GPS28。
            i1 = 0x10000000;
            EXCLUDE_SV[28] = i1.ToString("X");  //'GPS29。
            i1 = 0x20000000;
            EXCLUDE_SV[29] = i1.ToString("X");  //'GPS30。
            i1 = 0x40000000;
            EXCLUDE_SV[30] = i1.ToString("X");  //'GPS31。
            i1 = 0x80000000;
            EXCLUDE_SV[31] = i1.ToString("X");  //'GPS32。
            return;
        }
        //==========================================================================================
        ...
        */
        public long ProgressCall()
        {
            try
            {
                ...
                BASE_LINE_ANALYSER.ProgressInterface.CurPos(0) = (BASE_LINE_ANALYSER.Progress + BASE_LINE_ANALYSER.Index) / BASE_LINE_ANALYSER.Count * 100;
                BASE_LINE_ANALYSER.ProgressInterface.CurPos(1) = BASE_LINE_ANALYSER.Progress * 100;
                if (BASE_LINE_ANALYSER.ProgressInterface.Cancel())
                {
                    BASE_LINE_ANALYSER.Cancel = true;
                    return 1;
                }
